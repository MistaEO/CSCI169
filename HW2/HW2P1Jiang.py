def scope_test():
    def do_local():
         spam = "local spam"
         #creates a variable spam that is local to do_local
    def do_nonlocal():
        nonlocal spam
        spam = "nonlocal spam"
        #a spam variable that is not local to do_nonlocal but within the scope of scope_test will reference a new object that has the value "nonlocal spam"
    def do_global():
        global spam
        spam = "global spam"
        #global spam variable will reference a new object that has the value "global spam"
    spam = "test spam"
    #declaring spam as "test spam"
    do_local()
    #calling do_local
